				...
				{!! Form::model($members, [ 'method' => 'patch','route' => ['member.update', $member->id] ]) !!}
					...
					<div class="form-group">
			    		<div class="row">
				    		...
				    		<div class="col-md-10">
				    			{!! Form::text('course', $member->course, ['class' => 'form-control']) !!}
				    		</div>
				    	</div>
					</div>
					<div class="form-group">
			    		<div class="row">
				    		<div class="col-md-2" style="margin-top:7px;">
				    			{!! Form::label('qoutes', 'Qoutes') !!}
				    		</div>
				    		<div class="col-md-10">
				    			{!! Form::text('qoutes', $member->qoutes, ['class' => 'form-control']) !!}
				    		</div>
				    	</div>
			    	</div>
			</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				{!! Form::model($members, [ 'method' => 'delete','route' => ['member.delete', $member->id] ]) !!}
					...
					<h5 class="text-center">Name: {{$member->firstname}} {{$member->lastname}}{{$member->course}}{{$member->qoutes}}</h5>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Cancel</button>
